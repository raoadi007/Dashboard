        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $row_dt['full_name']; ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="index.php" class="btn btn-default btn-flat">Logout</a>
                </div>
              </li>
            </ul>
          </li>
            ...
            <form role="form">
              <div class="box-body" align="center">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="<?php echo $row_dt['full_name']; ?>" class="form-control" style="width: 250px;" id="exampleInputEmail1" placeholder="Name" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Username</label>
                  <input type="text" value="<?php echo $row_dt['username']; ?>" class="form-control" style="width: 250px;" id="exampleInputPassword1" placeholder="Username" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Password</label>
                  <input type="password" value="<?php echo $row_dt['password']; ?>" class="form-control" style="width: 250px;" id="exampleInputPassword1" placeholder="Password" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Status</label>
                  <input type="text" value="<?php echo $row_dt['status']; ?>" class="form-control" style="width: 250px;" id="exampleInputPassword1" placeholder="Username" readonly>
                </div>
                <br>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default">Update</button>
              </div>
              <!-- /.box-body -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form role="form" method="post" action="admin_profile.php">
              <div class="box-body" align="center">
                <div class="form-group">
                  <label for="exampleInputEmail1">Name</label>
