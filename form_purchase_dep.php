...
<head>
  ...
  <title>Purchase Department Form</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Purchase File Upload Here</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="../../pages/import/import_purchase.php" name="upload_excel" enctype="multipart/form-data">
    ...
    <!-- Main content -->
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Purchase Department Data Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                $sql_purchase="SELECT * FROM stg_purchase";
                $run=mysqli_query($ob->connect(),$sql_purchase);
                ...
                <tr>
                  ...
                  <td><?php echo $row['stg_Category']; ?></td>
                  <td><?php echo $row['stg_Unit_Item']; ?></td>
                  <td><?php echo $row['stg_Unit_Price']; ?></td>
                  <td><?php echo $row['stg_Quantity']; ?></td>
                  <td><?php echo $row['stg_Date']; ?></td>
                </tr>                
                </tbody>
                <?php 
              }
          ...
          <form method="post" action="../../pages/forms/save_load_purchase_dep.php">
          <div class="box-footer">
